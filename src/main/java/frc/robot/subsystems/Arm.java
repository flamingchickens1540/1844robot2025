...
public class Arm extends SubsystemBase {
      ...
      public enum ArmState {
        ...
        GROUND_CORAL_INTAKE(new LoggedTunableNumber("Arm/Setpoints/GroundCoralIntakeDegrees", 60)),
        GROUND_ALGAE_INTAKE(new LoggedTunableNumber("Arm/Setpoints/GroundAlgaeIntakeDegrees", 0)),
        L1_CORAL(new LoggedTunableNumber("Arm/Setpoints/L1CoralDegrees", 135)),
        HUMAN_PLAYER_INTAKE(new LoggedTunableNumber("Arm/Setpoints/HumanPlayerIntake", 0));
